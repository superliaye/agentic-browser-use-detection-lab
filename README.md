...
| [ChatGPT Desktop — Codex Computer Use](docs/approaches/chatgpt-desktop-codex-computer-use.md) | Launch, takeover | No known signal | Not observed in tested launch flow | Same result expected for takeover but not separately inspected | Product, browser, and OS versions not recorded |
