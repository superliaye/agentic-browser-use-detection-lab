...
Either detected signal also sets `isAutomationDetected` because agentic browser control is automation. Results latch even if the extension later removes the element.
